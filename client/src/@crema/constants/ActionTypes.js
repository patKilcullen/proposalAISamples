...
export const CREATE_NEW_PROPOSAL = 'create_new_proposal';
export const GET_BUSINESS_PROPOSAL = 'get_business_proposal';
export const GET_SINGLE_PROPOSAL = 'get_single_proposal';
export const EDIT_PROPOSAL = 'edit_proposal';
export const EDIT_PARTIAL_PROPOSAL = 'edit_partial_proposal'
export const EDIT_PROPOSAL_REVISION  = 'edit_proposal_revision'
export const EDIT_PROPOSAL_CURRENT_VERSION = 'edit_proposal_current_version'
...
export const GET_BUSINESS_PROPOSALS='get_business_proposals'
export const GET_USER_PROPOSALS='get_user_proposals'
export const GET_CLIENT_PROPOSALS ='get_client_proposals'
export const UPDATE_TEXT ='update_text'
export const GET_SINGLE_USER='get_single_user'
export const GET_UNIQUE_EMAILS="get_unique_emails"
export const FETCH_CONTACTS_START = 'fetch_contacts_start';
export const FETCH_CONTACTS_SUCCESS = 'fetch_contancts_success';
export const FETCH_CONTACTS_ERROR = 'fetch_contancts_error';
export const CREATE_USER = 'create_user';
export const REMOVE_BUSINESS_USER = 'remove_business_user'
export const FETCH_UPDATE_AI_START = 'fetch_update_ai_start'
export const ADD_CONTACTS = 'add_contacts'
export const ADD_PROPOSAL = 'add_proposal'
export const FETCH_START_OTP = 'fetch_start_otp';
export const FETCH_SUCCESS_OTP = 'fetch_success_otp';