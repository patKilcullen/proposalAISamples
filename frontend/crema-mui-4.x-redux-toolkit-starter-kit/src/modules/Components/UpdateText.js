...
//   const { updatedText } = useSelector(({ proposals }) => proposals);
//   const [conditions, setConditions] = useState('');
//   const [updatedTextContent, setUpdatedTextContent] = useState('');
//   const { loading } = useSelector(({ proposals }) => proposals);
  
//   // CLOSE MODAL: set values to false and empty strings
//   const handleClose = () => {
//     setShowUpdateText(false);
//     // setSelection ensure button doesnt appear in parent..
//     setSelection(false);
//     setConditions('');
//     setTextToReplace('');
...
//   // EDIT REPSONSE FROM AI: set updatedTextContect from resposne from state so it can be eidted
//   useEffect(() => {
...
//   // UPDATE Selected Text when user clicks update button, hits update paragraph action
//   const handleSubmitUpdateText = () => {
//     dispatch(onUpdateParagraph({ paragraph: textToReplace, conditions }));
//   };

//   // Cleanup function to clear updatedText from state when the component dismounts
//   useEffect(() => {
//     return () => {
...
//               my: 2,
//             }}
//             placeholder='explain how you you want the selected text to be altered'
//             value={conditions}
//             onChange={(e) => {
...
//             </Button>
//           </Box>
//           {/* IF receives updated text from AI and text was found in proposal, show response */}
//           { updatedTextContent ? (
//             <Box>
...
//                 textReplace={true}
//               />
//               {/* REPLACE TEXT IN PROPOSAL and close modal */}
//               <Box
...
//                   <Button onClick={() => dispatch(clearUpdatedText())} variant='contained'>
//                     Clear
//                   </Button>
//                   <Button
//                     onClick={() => {
...
//       {loading && (
//         <Box sx={{ zIndex: 99999999999 }}>
//           <AppLoader sx={{ zIndex: 9999 }} message={"ProposalAI is typing and rewriting..."} />
//         </Box>
//       )}
//     </>
//   );
